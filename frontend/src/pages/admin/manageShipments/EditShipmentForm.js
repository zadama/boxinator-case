...
const EditShipmentForm = (props) => {
  ...
  return (
    <form
      onSubmit={handleSubmit(props.updateShipment)}
    ...
    >
      ...
      <div className="form-group">
        ...
        <input
          ...
          name="account-id"
          defaultValue={
            props.shipment.account.id
              ? props.shipment.account.id
              : props.shipment.account
          }
          ref={register({ required: true })}
          readOnly
        />
      ...
      <div className="form-group">
        ...
        <select
          id="shipment-status"
          title={props.shipment.shipmentStatus}
      ...
      <div className="form-group">
        ...
        <select
          ...
          title={props.shipment.destinationCountry.name}
        >
      ...
      <div className="form-group">
        ...
        <select id="source-country" title={props.shipment.sourceCountry}>
